...
HD_PWD='D:/FPGA/Trash/calc_2/calc_1.runs/calc_check_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_check_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_check_floating_point_0_0.tcl
