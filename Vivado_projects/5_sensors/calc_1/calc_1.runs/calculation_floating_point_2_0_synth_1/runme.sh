...
HD_PWD='D:/FPGA/Trash/calc_2/calc_1.runs/calculation_floating_point_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calculation_floating_point_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calculation_floating_point_2_0.tcl
