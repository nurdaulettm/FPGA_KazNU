...
#
# Generated by Vivado on Wed Apr 04 17:21:29 +0600 2018
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb calc.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 02958141145c4546bf697b66daaa0f73 -m64 -L xbip_utils_v3_0_5 -L axi_utils_v2_0_1 -L xbip_pipe_v3_0_1 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_1 -L xbip_dsp48_multadd_v3_0_1 -L xbip_bram18k_v3_0_1 -L mult_gen_v12_0_10 -L floating_point_v7_1_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot calc xil_defaultlib.calc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim calc -key {Behavioral:sim_1:Functional:calc} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
