...
HD_PWD='D:/FPGA/Trash/sd_fat32_2.0/sd_fat32_2.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_fat32_controller_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sd_fat32_controller_wrapper.tcl -notrace
