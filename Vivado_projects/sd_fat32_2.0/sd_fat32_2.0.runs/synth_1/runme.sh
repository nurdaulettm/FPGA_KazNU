...
HD_PWD='D:/FPGA/Trash/sd_fat32_2.0/sd_fat32_2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_fat32_controller_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sd_fat32_controller_wrapper.tcl
