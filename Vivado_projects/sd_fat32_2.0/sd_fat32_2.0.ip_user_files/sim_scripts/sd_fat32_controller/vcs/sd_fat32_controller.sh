...
reset_run()
{
  files_to_remove=(ucli.key sd_fat32_controller_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc sd_fat32_controller_simv.daidir)
...
compile()
{
  ...
  vhdlan -work axi_intc_v4_1_5 $opts_vhd \
  ...
  vhdlan -work axi_quad_spi_v3_2_6 $opts_vhd \
  ...
  vhdlan -work axi_timer_v2_0_8 $opts_vhd \
  ...
  vlogan -work axi_clock_converter_v2_1_6 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  vlogan -work axi_dwidth_converter_v2_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.sd_fat32_controller xil_defaultlib.glbl -o sd_fat32_controller_simv
}
...
simulate()
{
  ...
  ./sd_fat32_controller_simv $opts -do simulate.do
}
# Script usage
usage()
{
