...
HD_PWD='D:/Documents/Vivado 2018/Trash/i2c_send_state_machine/i2c_send_state_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_send_sm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_send_sm.tcl -notrace
