...
HD_PWD='D:/Documents/Vivado 2018/Trash/i2c_send_state_machine/i2c_send_state_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_send_sm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_send_sm.tcl
