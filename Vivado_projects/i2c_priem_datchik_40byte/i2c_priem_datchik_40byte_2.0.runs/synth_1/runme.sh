...
HD_PWD='D:/FPGA/Trash/i2c_priem_datchik_40byte_2.0/i2c_priem_datchik_40byte_2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_40byte.vds -m64 -mode batch -messageDb vivado.pb -notrace -source i2c_40byte.tcl
