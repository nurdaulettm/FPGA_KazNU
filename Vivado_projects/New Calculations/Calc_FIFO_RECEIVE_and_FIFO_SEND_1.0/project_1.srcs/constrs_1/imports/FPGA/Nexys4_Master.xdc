...
set_property PACKAGE_PIN U8 [get_ports {sw[0]}]					
...
set_property PACKAGE_PIN R5 [get_ports {sw[3]}]					
...
set_property PACKAGE_PIN G14 [get_ports {data_in}]					
...
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = data_out3
#set_property PACKAGE_PIN V11 [get_ports {data_out[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {data_out[1]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = data_out4
#set_property PACKAGE_PIN V15 [get_ports {data_out[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {data_out[2]}]
##Bank = 15, Pin name = IO_25_15,							Sch name = data_out7
...
set_property PACKAGE_PIN H4 [get_ports {data_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data_out[0]}]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = data_out2
set_property PACKAGE_PIN H1 [get_ports {data_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data_out[1]}]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = data_out3
set_property PACKAGE_PIN G1 [get_ports {data_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data_out[2]}]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = data_out4
set_property PACKAGE_PIN G3 [get_ports {data_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data_out[3]}]
...
set_property PACKAGE_PIN F3 [get_ports {clk_out}]					
