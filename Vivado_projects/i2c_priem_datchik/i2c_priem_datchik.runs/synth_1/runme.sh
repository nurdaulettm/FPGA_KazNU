...
HD_PWD='D:/FPGA/Trash/i2c_priem_datchik/i2c_priem_datchik.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_main.vds -m64 -mode batch -messageDb vivado.pb -notrace -source i2c_main.tcl
