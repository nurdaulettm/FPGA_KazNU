...
HD_PWD='D:/FPGA/Trash/i2c_priem_datchik/i2c_priem_datchik.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_main.vdi -applog -m64 -messageDb vivado.pb -mode batch -source i2c_main.tcl -notrace
